...
def main():
    ...
    axes[1].hist(storm_plx.dropna(), bins=20, alpha=0.5, color='red', label=args.extname, density=True, histtype='step', linewidth=2, range=(plx_mean - 3, plx_mean + 3))
    axes[1].hist(gc_plx.dropna(), bins=20, alpha=0.5, color='blue', label='GaussCluster', density=True, range=(plx_mean - 3, plx_mean + 3))
